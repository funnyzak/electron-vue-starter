    ...
    electronBuilder: {
      builderOptions: {
        ...
        "nsis": {
          ...
          "installerIcon": "public/icon/256x256.ico", // 安装图标
          "uninstallerIcon": "public/icon/256x256.ico", //卸载图标
          "installerHeaderIcon": "public/icon/256x256.ico", // 安装时头部图标
          "createDesktopShortcut": true, // 创建桌面图标
          "createStartMenuShortcut": true, // 创建开始菜单图标
          "shortcutName": "demo", // 图标名称
        },
        "win": { //win相关配置
          "icon": "public/icon/256x256.ico", //图标，当前图标在根目录下，注意这里有两个坑
          "target": [{
